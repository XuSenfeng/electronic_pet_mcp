...
void LcdDisplay::SetupUI() {
    ...
    lv_obj_set_size(status_bar_, LV_HOR_RES, fonts_.text_font->line_height + 8);
    lv_obj_set_style_radius(status_bar_, 12, 0);
    lv_obj_set_style_bg_color(status_bar_, CUTE_WHITE, 0);
    lv_obj_set_style_text_color(status_bar_, current_theme_.text, 0);
    lv_obj_set_style_shadow_width(status_bar_, 8, 0);
    lv_obj_set_style_shadow_color(status_bar_, CUTE_PINK_LIGHT, 0);
    lv_obj_set_style_shadow_opa(status_bar_, 100, 0);
    // 不显示滚动条
    ...
    lv_obj_set_style_radius(content_, 20, 0);
    lv_obj_set_width(content_, LV_HOR_RES - 4);
    lv_obj_set_height(content_, LV_VER_RES - fonts_.text_font->line_height - 12);
    lv_obj_set_flex_grow(content_, 1);
    lv_obj_set_style_pad_all(content_, 15, 0);
    lv_obj_set_style_bg_color(content_, current_theme_.chat_background, 0);
    lv_obj_set_style_border_color(content_, current_theme_.border, 0);
    lv_obj_set_style_shadow_width(content_, 12, 0);
    lv_obj_set_style_shadow_color(content_, CUTE_PINK_LIGHT, 0);
    lv_obj_set_style_shadow_opa(content_, 80, 0);
    ...
    lv_obj_set_style_text_color(emotion_label_, CUTE_PINK_PRIMARY, 0);
    ...
    lv_obj_set_style_pad_column(status_bar_, 8, 0);
    lv_obj_set_style_pad_left(status_bar_, 12, 0);
    lv_obj_set_style_pad_right(status_bar_, 12, 0);

    /* 网络状态标签 */
    network_label_ = lv_label_create(status_bar_);
    lv_label_set_text(network_label_, "");
    lv_obj_set_style_text_font(network_label_, fonts_.icon_font, 0);
    lv_obj_set_style_text_color(network_label_, CUTE_PINK_PRIMARY, 0);
    ...
    lv_obj_set_style_text_color(mute_label_, CUTE_PINK_PRIMARY, 0);

    /* 电池标签 */
    battery_label_ = lv_label_create(status_bar_);
    lv_label_set_text(battery_label_, "");
    lv_obj_set_style_text_font(battery_label_, fonts_.icon_font, 0);
    lv_obj_set_style_text_color(battery_label_, CUTE_PINK_PRIMARY, 0);

    /* 可爱风格低电量弹窗 */
    low_battery_popup_ = lv_obj_create(screen_main_);
    lv_obj_set_scrollbar_mode(low_battery_popup_, LV_SCROLLBAR_MODE_OFF);
    lv_obj_set_size(low_battery_popup_, LV_HOR_RES * 0.85, fonts_.text_font->line_height * 2.5);
    ...
    lv_obj_set_style_radius(low_battery_popup_, 25, 0);
    lv_obj_set_style_shadow_width(low_battery_popup_, 15, 0);
    lv_obj_set_style_shadow_color(low_battery_popup_, CUTE_PINK_DARK, 0);
    lv_obj_set_style_shadow_opa(low_battery_popup_, 150, 0);
    lv_obj_set_style_pad_all(low_battery_popup_, 15, 0);
